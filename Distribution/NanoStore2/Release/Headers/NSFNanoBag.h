...
@property (weak, readonly) NSFNanoStore *store;
/*! The name of the bag.  */
...
+ (instancetype)bagWithObjects:(NSArray*)theObjects;
...
- initBagWithName:(NSString*)theName andObjects:(NSArray*)someObjects;
